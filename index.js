...
conn.sendMessage(id, 'Owner KOF BOT wa.me/+6289601416330' ,MessageType.text);
}
...
if (text.includes("#acall")){
	const text = text.replace(/#acall /, "")
	axios.get(`https://arugaz.herokuapp.com/api/spamcall?no=${text}`).then ((res) => {
